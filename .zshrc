...
POWERLEVEL9K_MULTILINE_SECOND_PROMPT_PREFIX="  %F{white}\Uf1d1%f %F{cyan}\uf101 %f"
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(virtualenv command_execution_time background_jobs_joined time_joined)
